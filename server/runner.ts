...
export function buildStepPrompt(
  ...
  const lines = [
    ...
    '- ENGLISH ALWAYS, whatever the document language: code and code samples, identifiers, file and folder names, commands, environment-variable names, database table and column names, API paths and field names, branch and commit conventions, and every frontmatter key. Only the prose is written in the brief\'s language — never translate a name something is called by.',
