...
### 5.13 Motor implementation başladı — mimari prensip + Madde 1, 2, 3 (2026-05-31)
...
- **Bağımlılık sırası (doğrulandı, Layer 0→3):** L0 paralel [**1✅**, **2✅**, **3✅**, 11(bağımsız)] → L1 [**4(←1+2+3) ← SIRADAKİ**, 5(←1+2), 7] → L2 [6(←1+4), 9(←1)] → L3 [8(←6), 10 capstone]. **Layer 0 (11 hariç) TAMAM → Madde 4 (gate join) açık.**
