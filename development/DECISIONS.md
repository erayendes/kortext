...
- **Bağımlılık sırası (doğrulandı, Layer 0→3):** L0 paralel [**1✅**, **2✅**, **3✅**, 11(bağımsız)] → L1 [**4✅**, 5(←1+2), 7] → L2 [6(←1+4), 9(←1)] → L3 [8(←6), 10 capstone]. **Layer 0 + Madde 4 TAMAM → test-cycle mekaniği çalışıyor. Sıradaki adaylar: uat (review +prime, Madde 4'ün eşi) · 6 (closure ←artık açık) · 5 (whose-turn) · 9 (block).**
