...
- [ ] **Canlı koşu — epic/versiyon/model + dev-cycle paralelliği + kapı revize** (2026-06-05, DECISIONS Bölüm 14.1/14.2/14.3). Ingestion (epic/version/parent/model sütunları) + driver Phase 2/3 paralelliği + yeni kapı-revize semantiği **745 test yeşil** ama **gerçek-Claude ile canlı kanıt yapılmadı**. Mock ile analiz kapıları + revize kanıtlandı. ~25dk, executor=claude, UAT kum havuzu.
