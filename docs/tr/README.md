...
Yeni bir sürüm çıktığında panel başlığın altında mavi bir şeritle haber verir — açılışta ve sonra her saat bakar. **Update now** düğmesi kurulumu sizin yerinize yapar, sonra **Quit** sunar; yeni sürüm, kortext'i yeniden açtığınızda devreye girer. Düğme, koşan bir adım varsa dosyaları onun altından değiştirmez, bitmesini bekler. Elle yapmak isterseniz, ya da düğme hata verirse:
