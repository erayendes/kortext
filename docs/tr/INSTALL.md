...
```
Kurulum bittikten sonra `kortext` yazın. Sunucu ayağa kalkar, tarayıcınız açılır ve Kortext paneli karşınıza gelir. Hepsi bu. Sonrası [GUIDE](GUIDE.md)'da; macOS'ta menü çubuğu uygulaması için [MACOS](MACOS.md).
...
> Bir şey çalışmazsa lütfen [bir issue açın](https://github.com/erayendes/kortext/issues); sorun muhtemelen sizin kurulumunuzda değildir.
...
Düğme, koşan bir adım varsa bitmesini bekler. 

Güncellemeyi elle yapmak isterseniz, ya da düğme hata verirse:
...
Kaldırmak yalnızca Kortext'i siler. Proje kaydınız ve loglar `~/.kortext/`'te, belgeleriniz de repo'nuzda olduğu gibi kalır. 
