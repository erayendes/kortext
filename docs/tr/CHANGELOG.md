...
- **EXPERIENCE.md, isteğe bağlı.** Zincirin sıraya koymadığı, el sıkışmada sunulan bir belge
  ...
  zaten elinizdeyse atlayın. Proje eklerken hangisi olduğu soruluyor — *Design to be made*, *Design in hand* (dosyalar
  proje klasöründe), *No design* — ve `DESIGN.md` eldeki tasarımı icat etmek yerine belgeliyor. El sıkışmadan sonra belge proje
  sahibinindir.
