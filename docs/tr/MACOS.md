...
Her proje için bir kart bulunur. Karar gerektiren bir satırı tıkladığınızda [panel](GUIDE.md) o belgede açılır. Bekleyen belge olmadığında bu durum belirtilir.
