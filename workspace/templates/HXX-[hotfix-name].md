...
> **Skills:** [`skills/[ajan]/[düzeltme-için-skill]`]
...
2. Staging deploy + smoke test (`05-test-cycle.md`)
3. Onaylar:
...
6. Production deploy (`06-deployment-cycle.md`)
...
## Rollback Plan
[Hotfix beklenen sonucu vermezse `07-rollback-pipeline.md` tetiklenir. Geri dönüş adımları:]
- [Adım 1]
- [Adım 2]
...
- **Learned entry:** [`workspace/memory/learned.md` linki]
