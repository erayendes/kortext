...
To try what is not released yet: `npm i -g kortext@beta`, and the app from the latest pre-release; the app's settings can switch the package between the beta and the release.
