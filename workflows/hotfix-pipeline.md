...
3. **+engineering-manager:** Post-mortem yaz (`.kortext/memory/learned.md`'e işle): severity, etkilenen modül, etki süresi, kök neden, tespit, düzeltme gerekçesi, tekrar önleme. Motor incident bug'ını `done` yapar; kapsam büyüdüyse yeni Task/Debt açılır; kullanıcı bildirimi gerekiyorsa +delivery-manager release notes'a delege.
